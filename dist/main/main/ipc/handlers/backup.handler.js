...
export class BackupHandler {
    constructor(db) {
        ...
        Object.defineProperty(this, "backupService", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
    ...
    async create(event, description) {
        try {
    ...
    async restore(event, backupPath) {
        try {
    ...
    async exportToUSB(event, usbPath, backupFilePath) {
        try {
